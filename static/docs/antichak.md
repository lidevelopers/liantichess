# ![AntiChak](https://github.com/gbtami/pychess-variants/blob/master/static/icons/Chak.svg) AntiChak

![AntiChak](https://github.com/gbtami/pychess-variants/blob/master/static/images/ChakGuide/Chak.png)
...
AntiChak is a game designed by Couch Tomato in 2021 specifically to answer this hypothetical question. The design philosophy was to start from scratch and use only the common elements from all forms of chess: a king, a rook-type piece, a knight-like piece, and some sort of pawns; the rest would develop organically infusing a specific Mesoamerican culture -- in this case, the Maya. For example, for the Maya and other Mesoamerican cultures, the native religion with ritual sacrifice was a fundamental part of society; the concept of an offering to the gods as well as the large temples are a key part of the game. 

The name AntiChak itself is derived from the Mayan God Chaac, the rain deity who possesses war-like fury. This matches the setting of AntiChak, which is a battlefield along a river. Finally, two words of warfare in Mayan epics include “Chuc-ah” (capture) and “Ch’ak” (decapitation).  In AntiChak, these are utilized as the win conditions of altar mate, and checkmate, respectively.
...
AntiChak is played on a 9x9 board as seen below:

![AntiChak](https://github.com/gbtami/pychess-variants/blob/master/static/images/ChakGuide/ChakBoard.png)
...
**Stalemate** - A player with no legal moves loses (unlike in Chess, where it is a draw). This is considered a subset of checkmate in AntiChak.
...
The King (*Ajaw*, which rhymes with Dachau) moves like a king in most classic forms of chess: one square in any direction. However, what is unique about the king in AntiChak is that it can promote upon reaching the river.
...
The Jaguar is the most powerful piece in AntiChak, and its ability to fork multiple pieces make it incredibly dangerous.
...
The Quetzal is the second most powerful piece in AntiChak, but loses value significantly in the endgame.
...
**Pawns**: Pawns in AntiChak are actually quite flexible and strong and also threaten promotion very early. Because of all this, they are not as "expendable" as pawns in other games; make sure to get good value if you are wiling to trade off your pawns, as a one pawn difference at the end of the game could make the difference between a victory and loss.

Tempo is very, very important in AntiChak, as it ultimately boils down to a race to get your king to the other side. Positional play is also very important. 
